 ...
 * Thresholds are more gradual for smoother transitions
 */
export const LOD_LEVELS: LODLevelConfig[] = [
  { level: 0, resolution: 2, maxScreenSize: 30 },    // 2 triangles
  { level: 1, resolution: 4, maxScreenSize: 80 },    // 18 triangles
  { level: 2, resolution: 7, maxScreenSize: 150 },   // 72 triangles
  { level: 3, resolution: 9, maxScreenSize: 300 },   // 128 triangles
